...
<body>
	...
	<div class="container">
		<ol class="breadcrumb">
			<li><a href="">Home</a></li>
			<li class="active">eGPS Browse</li>
		</ol>
		<div class="panel panel-default panel-note">
			<div class="panel-body" style="font-style:italic;">
				eGPS<s:text name="umbrella.totalProjects"/> <s:property value="totalCount"/>&nbsp;&nbsp;&nbsp;&nbsp;
				...
				&nbsp;<s:text name="umbrella.totalDownloads"/> 1839 (GB)
			</div>
		</div>
		<div class="panel panel-default">
			...
			<div class="panel-list">
				<table class="table table-list table-border table-hover">
					<thead>
						<tr>
							<th><s:text name="egps.accession"/></th>
					...
					<tbody>
						<s:iterator value="listProjects" status="status">
							<tr>
								...
								<td><a href="browse/egps/egpsProjectDetail?accession=<s:property value='accession'/>"><s:property value="accession" />
								</a>
								</td>

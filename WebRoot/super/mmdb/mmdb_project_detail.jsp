...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
	...
	<div class="container">
		<ol class="breadcrumb">
			<li><a href="">Home</a></li>
			<li class="active"><a href="browse/mmdb/list">MMDB Browse</a></li>
										...
										<s:iterator value="wrappedProject.samples" id="sample">
											<tr>
												<td style=" text-indent:24px">
													...
													<s:else>
														<s:property value="#sample.accession" />
													</s:else>
													<%--<a href="../../biosample/browse/<s:property value='#sample.accession'/>"><s:property value="#sample.accession" /></a>--%>
												</td>
											...
											<tr>
												<td style=" text-indent:24px">
													<s:if test="#cra.releaseState==2">
														<a href="https://ngdc.cncb.ac.cn/gsa/browse/<s:property value='#cra.accession'/>"><s:property value="#cra.accession" /></a>
													</s:if>
													<s:else>

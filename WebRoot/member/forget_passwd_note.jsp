...
<jsp:include page="/inc/header.jsp"/>
    <div class="container">
		...
		<div class="panel panel-default panel-info">
			<div class="panel-heading">Check code succeeded</div>
			<div class="panel-body">
				We have sent an email to this mail address. Please Log in to the email and reset your account within 1 hour.<br/>
			</div>	
		</div>
    </div>
</body>

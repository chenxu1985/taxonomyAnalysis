...
<jsp:include page="/inc/header_project.jsp"/>
    <div class="container">
		...
		<div class="panel panel-default panel-info">
			<%--<div class="panel-heading"><s:property value='accession'/> <s:text name="gsa.information"/></div>--%>
			<div class="panel-body">
					The data you are retrieving does not exist in GSA: <s:property value='second_accession'/>
			</div>	
		</div>
    </div>
</body>
